...
<html lang="en">
    ...
    <body data-spy="scroll" data-target="#template-navbar">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="Food-fair-toggle">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="#reserve">Payment</a></li>
        ...
        {{-- <img class="img-responsive section-icon hidden-sm hidden-xs" src="{{asset('frontend/images/icons/reserve_black.png')}}"> --}}
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row dis-table">
                        <div class="col-xs-6 col-sm-6 dis-table-cell color-bg">
                            <h2 class="section-title">Spp Payment ~</h2>
                        </div>
                        <div class="col-xs-6 col-sm-6 dis-table-cell section-bg">
        ...
        <section class="reservation">
            <h2 style="" class="text-center mt-5">Payment</h2>
                                ...
                                <form class="reservation-form" method="post" action="{{route('reservation.reserve')}}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <input autocomplete="off" type="text" class="form-control reserve-form empty iconified" name="dateandtime" id="datetimepicker1"  placeholder="&#xf017;  Time">
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select class="form-control" name="bulan" >
                                                        <option selected >Bulan Pembayaran   </option>
                                                        <option value="Januari"{{(old('bulan') == 'J') ? 'selected' : ''}}>Januari</option>
                                                        <option value="Februari"{{(old('bulan') == 'F') ? 'selected' : ''}}>Februari</option>
                                                        <option value="Maret"{{(old('bulan') == 'M') ? 'selected' : ''}}>Maret</option>
                                                        <option value="April"{{(old('bulan') == 'A') ? 'selected' : ''}}>April</option>
                                                        <option value="Mei"{{(old('bulan') == 'M') ? 'selected' : ''}}>Mei</option>
                                                        <option value="Juni"{{(old('bulan') == 'J') ? 'selected' : ''}}>Juni</option>
                                                        <option value="Juli"{{(old('bulan') == 'J') ? 'selected' : ''}}>Juli</option>
                                                        <option value="Agustus"{{(old('bulan') == 'A') ? 'selected' : ''}}>Agustus</option>
                                                        <option value="September"{{(old('bulan') == 'S') ? 'selected' : ''}}>September</option>
                                                        <option value="Oktober"{{(old('bulan') == 'O') ? 'selected' : ''}}>Oktober</option>
                                                        <option value="November"{{(old('bulan') == 'N') ? 'selected' : ''}}>November</option>
                                                        <option value="Desember"{{(old('bulan') == 'D') ? 'selected' : ''}}>Desember</option>
                                        ...
                                        <div class="form-group">
                                            <div class="form-group label-floating">
                                                ...
                                                <select class="form-control" name="class" >
                                                    ...
                                                    <option value="XII"{{(old('class') == 'J') ? 'selected' : ''}}>XII RPL 1</option>
                                                    <option value="XI"{{(old('class') == 'F') ? 'selected' : ''}}>XI RPL 1</option>
                                                    <option value="X"{{(old('class') == 'M') ? 'selected' : ''}}>X RPL 1</option>
            ...
            <div class="container-fluid color-bg">
                <div class="row dis-table">
                    ...
                    <div class="col-xs-6 col-sm-6 dis-table-cell">
                        <div class="section-content">
                            <p>Fitur Contact digunakan apabila</p>
                            <p>User tidak mendapat pesan apapun,<br>baik notifikasi maupun email</p>
                            <p>Terimakasih</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2020 Theme by <a href="#"  target="_blank">Kfajarbowo</a>
                            </p>
                        </div>
                    </div>
                </div>
