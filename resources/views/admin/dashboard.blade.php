            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-stats">
                        ...
                        <div class="card-content">
                            <p class="category">Siswa / Kelas</p>
                            <h3 class="title">{{ $siswaCount }}/{{ $kelasCount }}
                            </h3>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-stats">
                        ...
                        <div class="card-content">
                            <p class="category">Spp Count</p>
                            <h3 class="title">{{ $sppCount }}</h3>
                        </div>
                        <div class="card-footer">
                            <div class="stats">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header" data-background-color="purple">
                            <h4 class="title">Record Payment</h4>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                     ...
                                     <td>
                                         ...
                                         <button type="button" class="btn btn-info btn-sm" onclick="if(confirm('Verifikasi Pembayaran ini?')){
